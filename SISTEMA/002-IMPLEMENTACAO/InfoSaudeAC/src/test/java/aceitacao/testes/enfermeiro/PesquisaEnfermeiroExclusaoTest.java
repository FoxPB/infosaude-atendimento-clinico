...
public class PesquisaEnfermeiroExclusaoTest {
    ...
    public void testPesquisaEnfermeiroExclusao() throws Exception {
        ...
        driver.findElement(By.id("formCadastroEnfermeiro:coren")).sendKeys("78451");
        driver.findElement(By.id("formCadastroEnfermeiro:cpf")).clear();
        driver.findElement(By.id("formCadastroEnfermeiro:cpf")).sendKeys("515.124.304-71");
        driver.findElement(By.id("formCadastroEnfermeiro:cartaoSus")).clear();
        driver.findElement(By.id("formCadastroEnfermeiro:cartaoSus")).sendKeys("788 4551 2200");
        ...
        try {
            assertEquals("Lucas Pato", driver.findElement(By.xpath("//tbody[@id='formPesquisaEnfermeiro:datatablePesquisaEnfermeiro_data']/tr/td[2]")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        driver.findElement(By.id("formPesquisaEnfermeiro:datatablePesquisaEnfermeiro:0:deleteButton")).click();
        // Warning: verifyTextNotPresent may require manual changes
        try {
            assertFalse(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*//tbody\\[@id='formPesquisaEnfermeiro:datatablePesquisaEnfermeiro_data'\\]/tr/td\\[2\\][\\s\\S]*$"));
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
    }
