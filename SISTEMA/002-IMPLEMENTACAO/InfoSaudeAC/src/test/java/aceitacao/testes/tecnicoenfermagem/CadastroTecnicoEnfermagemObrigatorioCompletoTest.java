...
public class CadastroTecnicoEnfermagemObrigatorioCompletoTest {
    ...
    @Test
    public void testCadastroTecnicoEnfermagemObrigatorioCompleto() throws Exception {
        ...
        driver.findElement(By.id("formCadastroTecnicoEnfermagem:nome")).sendKeys("Luis Ganso");
