...
public class CadastroEnfermeiroObrigatorioCompletoRepetidoTest {
    ...
    public void testCadastroEnfermeiroObrigatorioCompletoRepetido() throws Exception {
        ...
        driver.findElement(By.id("formCadastroEnfermeiro:coren")).sendKeys("1240001");
        driver.findElement(By.id("formCadastroEnfermeiro:cpf")).clear();
        driver.findElement(By.id("formCadastroEnfermeiro:cpf")).sendKeys("131.784.202-23");
        driver.findElement(By.id("formCadastroEnfermeiro:cartaoSus")).clear();
        driver.findElement(By.id("formCadastroEnfermeiro:cartaoSus")).sendKeys("01234560000");
        driver.findElement(By.id("formCadastroEnfermeiro:nome")).clear();
        driver.findElement(By.id("formCadastroEnfermeiro:nome")).sendKeys("Ed Corvo");
